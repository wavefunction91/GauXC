...
void integral_2_2(int npts,
   ...
   for(int point_idx = 0; point_idx < npts; ++point_idx) {
      ...
      *(Gjk + 3 * ldG) += *(Xik + 1 * ldX) * t3;
      *(Gik + 1 * ldG) += *(Xjk + 3 * ldX) * t3;
      t4 = *(temp + 23) * const_value;
      *(Gjk + 4 * ldG) += *(Xik + 1 * ldX) * t4;
      *(Gik + 1 * ldG) += *(Xjk + 4 * ldX) * t4;
      t5 = *(temp + 24) * const_value;
      *(Gjk + 5 * ldG) += *(Xik + 1 * ldX) * t5;
      *(Gik + 1 * ldG) += *(Xjk + 5 * ldX) * t5;
      ...
      *(Gjk + 3 * ldG) += *(Xik + 2 * ldX) * t3;
      *(Gik + 2 * ldG) += *(Xjk + 3 * ldX) * t3;
      t4 = *(temp + 24) * const_value;
      *(Gjk + 4 * ldG) += *(Xik + 2 * ldX) * t4;
      *(Gik + 2 * ldG) += *(Xjk + 4 * ldX) * t4;
      t5 = *(temp + 25) * const_value;
      *(Gjk + 5 * ldG) += *(Xik + 2 * ldX) * t5;
      *(Gik + 2 * ldG) += *(Xjk + 5 * ldX) * t5;
      ...
      *(Gjk + 0 * ldG) += *(Xik + 3 * ldX) * t0;
      *(Gik + 3 * ldG) += *(Xjk + 0 * ldX) * t0;
      t1 = *(temp + 22) * const_value;
      *(Gjk + 1 * ldG) += *(Xik + 3 * ldX) * t1;
      *(Gik + 3 * ldG) += *(Xjk + 1 * ldX) * t1;
      t2 = *(temp + 23) * const_value;
      *(Gjk + 2 * ldG) += *(Xik + 3 * ldX) * t2;
      *(Gik + 3 * ldG) += *(Xjk + 2 * ldX) * t2;
      t3 = *(temp + 26) * const_value;
      *(Gjk + 3 * ldG) += *(Xik + 3 * ldX) * t3;
      *(Gik + 3 * ldG) += *(Xjk + 3 * ldX) * t3;
      t4 = *(temp + 27) * const_value;
      *(Gjk + 4 * ldG) += *(Xik + 3 * ldX) * t4;
      *(Gik + 3 * ldG) += *(Xjk + 4 * ldX) * t4;
      t5 = *(temp + 28) * const_value;
      *(Gjk + 5 * ldG) += *(Xik + 3 * ldX) * t5;
      *(Gik + 3 * ldG) += *(Xjk + 5 * ldX) * t5;
      ...
      *(Gjk + 0 * ldG) += *(Xik + 4 * ldX) * t0;
      *(Gik + 4 * ldG) += *(Xjk + 0 * ldX) * t0;
      t1 = *(temp + 23) * const_value;
      *(Gjk + 1 * ldG) += *(Xik + 4 * ldX) * t1;
      *(Gik + 4 * ldG) += *(Xjk + 1 * ldX) * t1;
      t2 = *(temp + 24) * const_value;
      *(Gjk + 2 * ldG) += *(Xik + 4 * ldX) * t2;
      *(Gik + 4 * ldG) += *(Xjk + 2 * ldX) * t2;
      t3 = *(temp + 27) * const_value;
      *(Gjk + 3 * ldG) += *(Xik + 4 * ldX) * t3;
      *(Gik + 4 * ldG) += *(Xjk + 3 * ldX) * t3;
      t4 = *(temp + 28) * const_value;
      *(Gjk + 4 * ldG) += *(Xik + 4 * ldX) * t4;
      *(Gik + 4 * ldG) += *(Xjk + 4 * ldX) * t4;
      t5 = *(temp + 29) * const_value;
      *(Gjk + 5 * ldG) += *(Xik + 4 * ldX) * t5;
      *(Gik + 4 * ldG) += *(Xjk + 5 * ldX) * t5;
      ...
      *(Gjk + 0 * ldG) += *(Xik + 5 * ldX) * t0;
      *(Gik + 5 * ldG) += *(Xjk + 0 * ldX) * t0;
      t1 = *(temp + 24) * const_value;
      *(Gjk + 1 * ldG) += *(Xik + 5 * ldX) * t1;
      *(Gik + 5 * ldG) += *(Xjk + 1 * ldX) * t1;
      t2 = *(temp + 25) * const_value;
      *(Gjk + 2 * ldG) += *(Xik + 5 * ldX) * t2;
      *(Gik + 5 * ldG) += *(Xjk + 2 * ldX) * t2;
      t3 = *(temp + 28) * const_value;
      *(Gjk + 3 * ldG) += *(Xik + 5 * ldX) * t3;
      *(Gik + 5 * ldG) += *(Xjk + 3 * ldX) * t3;
      t4 = *(temp + 29) * const_value;
      *(Gjk + 4 * ldG) += *(Xik + 5 * ldX) * t4;
      *(Gik + 5 * ldG) += *(Xjk + 4 * ldX) * t4;
