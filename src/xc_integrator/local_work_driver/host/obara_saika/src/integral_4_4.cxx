...
void integral_4_4(size_t npts,
   ...
   for(p_outer = 0; p_outer < npts_upper; p_outer += NPTS_LOCAL) {
      ...
      for(int ij = 0; ij < shpair.nprim_pair; ++ij) {
         ...
         GauXC::boys_function<5>(NPTS_LOCAL, Tval, FmT + 5 * NPTS_LOCAL);
         GauXC::boys_function<6>(NPTS_LOCAL, Tval, FmT + 6 * NPTS_LOCAL);
         GauXC::boys_function<7>(NPTS_LOCAL, Tval, FmT + 7 * NPTS_LOCAL);
         GauXC::boys_function<8>(NPTS_LOCAL, Tval, FmT + 8 * NPTS_LOCAL);
   ...
   for(; p_outer < npts; p_outer += NPTS_LOCAL) {
      ...
      for(int ij = 0; ij < shpair.nprim_pair; ++ij) {
         ...
         GauXC::boys_function<7>(npts_inner, Tval, FmT + 7 * NPTS_LOCAL);
         GauXC::boys_function<8>(npts_inner, Tval, FmT + 8 * NPTS_LOCAL);
