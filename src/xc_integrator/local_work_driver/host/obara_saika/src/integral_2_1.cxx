...
void integral_2_1(size_t npts,
                  ...
                  int ldG, 
                  double *weights) {
   __attribute__((__aligned__(64))) double buffer[16 * NPTS_LOCAL + 5 * NPTS_LOCAL + NPTS_LOCAL];

   double *temp = (buffer + 0);
   double *FmT = (buffer + 16 * NPTS_LOCAL);
   double *Tval = (buffer + 16 * NPTS_LOCAL + 5 * NPTS_LOCAL);
