...
void integral_3_2(size_t npts,
                  ...
                  int ldG, 
                  double *weights) {
   __attribute__((__aligned__(64))) double buffer[46 * NPTS_LOCAL + 7 * NPTS_LOCAL + NPTS_LOCAL];

   double *temp = (buffer + 0);
   double *FmT = (buffer + 46 * NPTS_LOCAL);
   double *Tval = (buffer + 46 * NPTS_LOCAL + 7 * NPTS_LOCAL);
