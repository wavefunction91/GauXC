...
void integral_3_1(size_t npts,
                  ...
                  int ldG, 
                  double *weights) {
   __attribute__((__aligned__(64))) double buffer[25 * NPTS_LOCAL + 7 * NPTS_LOCAL + NPTS_LOCAL];

   double *temp = (buffer + 0);
   double *FmT = (buffer + 25 * NPTS_LOCAL);
   double *Tval = (buffer + 25 * NPTS_LOCAL + 7 * NPTS_LOCAL);
