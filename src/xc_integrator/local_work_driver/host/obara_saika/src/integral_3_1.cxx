...
void integral_3_1(size_t npts,
   ...
   for(size_t point_idx = 0; point_idx < npts; ++point_idx) {
      ...
      t0 = *(temp + 10) * const_value * (*(weights + point_idx));
      *(Gik + 0 * ldG) += *(Xjk + 0 * ldX) * t0;
      *(Gjk + 0 * ldG) += *(Xik + 0 * ldX) * t0;
      t1 = *(temp + 11) * const_value * (*(weights + point_idx));
      *(Gik + 1 * ldG) += *(Xjk + 0 * ldX) * t1;
      *(Gjk + 0 * ldG) += *(Xik + 1 * ldX) * t1;
      t2 = *(temp + 12) * const_value * (*(weights + point_idx));
      ...
      *(Gjk + 0 * ldG) += *(Xik + 5 * ldX) * t5;
      t6 = *(temp + 16) * const_value * (*(weights + point_idx));
      *(Gik + 6 * ldG) += *(Xjk + 0 * ldX) * t6;
      *(Gjk + 0 * ldG) += *(Xik + 6 * ldX) * t6;
      t7 = *(temp + 17) * const_value * (*(weights + point_idx));
      *(Gik + 7 * ldG) += *(Xjk + 0 * ldX) * t7;
      *(Gjk + 0 * ldG) += *(Xik + 7 * ldX) * t7;
      t8 = *(temp + 18) * const_value * (*(weights + point_idx));
      *(Gik + 8 * ldG) += *(Xjk + 0 * ldX) * t8;
      *(Gjk + 0 * ldG) += *(Xik + 8 * ldX) * t8;
      t9 = *(temp + 19) * const_value * (*(weights + point_idx));
      ...
      *(Gjk + 0 * ldG) += *(Xik + 9 * ldX) * t9;
      ...
      t0 = *(temp + 11) * const_value * (*(weights + point_idx));
      *(Gik + 0 * ldG) += *(Xjk + 1 * ldX) * t0;
      *(Gjk + 1 * ldG) += *(Xik + 0 * ldX) * t0;
      t1 = *(temp + 13) * const_value * (*(weights + point_idx));
      *(Gik + 1 * ldG) += *(Xjk + 1 * ldX) * t1;
      *(Gjk + 1 * ldG) += *(Xik + 1 * ldX) * t1;
      t2 = *(temp + 14) * const_value * (*(weights + point_idx));
      *(Gik + 2 * ldG) += *(Xjk + 1 * ldX) * t2;
      *(Gjk + 1 * ldG) += *(Xik + 2 * ldX) * t2;
      t3 = *(temp + 16) * const_value * (*(weights + point_idx));
      *(Gik + 3 * ldG) += *(Xjk + 1 * ldX) * t3;
      *(Gjk + 1 * ldG) += *(Xik + 3 * ldX) * t3;
      t4 = *(temp + 17) * const_value * (*(weights + point_idx));
      *(Gik + 4 * ldG) += *(Xjk + 1 * ldX) * t4;
      *(Gjk + 1 * ldG) += *(Xik + 4 * ldX) * t4;
      t5 = *(temp + 18) * const_value * (*(weights + point_idx));
      *(Gik + 5 * ldG) += *(Xjk + 1 * ldX) * t5;
      *(Gjk + 1 * ldG) += *(Xik + 5 * ldX) * t5;
      t6 = *(temp + 20) * const_value * (*(weights + point_idx));
      *(Gik + 6 * ldG) += *(Xjk + 1 * ldX) * t6;
      *(Gjk + 1 * ldG) += *(Xik + 6 * ldX) * t6;
      t7 = *(temp + 21) * const_value * (*(weights + point_idx));
      *(Gik + 7 * ldG) += *(Xjk + 1 * ldX) * t7;
      *(Gjk + 1 * ldG) += *(Xik + 7 * ldX) * t7;
      t8 = *(temp + 22) * const_value * (*(weights + point_idx));
      *(Gik + 8 * ldG) += *(Xjk + 1 * ldX) * t8;
      *(Gjk + 1 * ldG) += *(Xik + 8 * ldX) * t8;
      t9 = *(temp + 23) * const_value * (*(weights + point_idx));
      ...
      *(Gjk + 1 * ldG) += *(Xik + 9 * ldX) * t9;
      ...
      t0 = *(temp + 12) * const_value * (*(weights + point_idx));
      *(Gik + 0 * ldG) += *(Xjk + 2 * ldX) * t0;
      *(Gjk + 2 * ldG) += *(Xik + 0 * ldX) * t0;
      t1 = *(temp + 14) * const_value * (*(weights + point_idx));
      *(Gik + 1 * ldG) += *(Xjk + 2 * ldX) * t1;
      *(Gjk + 2 * ldG) += *(Xik + 1 * ldX) * t1;
      t2 = *(temp + 15) * const_value * (*(weights + point_idx));
      *(Gik + 2 * ldG) += *(Xjk + 2 * ldX) * t2;
      *(Gjk + 2 * ldG) += *(Xik + 2 * ldX) * t2;
      t3 = *(temp + 17) * const_value * (*(weights + point_idx));
      *(Gik + 3 * ldG) += *(Xjk + 2 * ldX) * t3;
      *(Gjk + 2 * ldG) += *(Xik + 3 * ldX) * t3;
      t4 = *(temp + 18) * const_value * (*(weights + point_idx));
      *(Gik + 4 * ldG) += *(Xjk + 2 * ldX) * t4;
      *(Gjk + 2 * ldG) += *(Xik + 4 * ldX) * t4;
      t5 = *(temp + 19) * const_value * (*(weights + point_idx));
      *(Gik + 5 * ldG) += *(Xjk + 2 * ldX) * t5;
      *(Gjk + 2 * ldG) += *(Xik + 5 * ldX) * t5;
      t6 = *(temp + 21) * const_value * (*(weights + point_idx));
      *(Gik + 6 * ldG) += *(Xjk + 2 * ldX) * t6;
      *(Gjk + 2 * ldG) += *(Xik + 6 * ldX) * t6;
      t7 = *(temp + 22) * const_value * (*(weights + point_idx));
      *(Gik + 7 * ldG) += *(Xjk + 2 * ldX) * t7;
      *(Gjk + 2 * ldG) += *(Xik + 7 * ldX) * t7;
      t8 = *(temp + 23) * const_value * (*(weights + point_idx));
      *(Gik + 8 * ldG) += *(Xjk + 2 * ldX) * t8;
      *(Gjk + 2 * ldG) += *(Xik + 8 * ldX) * t8;
      t9 = *(temp + 24) * const_value * (*(weights + point_idx));
