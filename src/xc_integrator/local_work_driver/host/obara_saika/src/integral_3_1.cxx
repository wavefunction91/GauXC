...
void integral_3_1(int npts,
   ...
   for(int point_idx = 0; point_idx < npts; ++point_idx) {
      ...
      *(Gjk + 6 * ldG) += *(Xik + 0 * ldX) * t6;
      *(Gik + 0 * ldG) += *(Xjk + 6 * ldX) * t6;
      t7 = *(temp + 17) * const_value;
      *(Gjk + 7 * ldG) += *(Xik + 0 * ldX) * t7;
      *(Gik + 0 * ldG) += *(Xjk + 7 * ldX) * t7;
      t8 = *(temp + 18) * const_value;
      *(Gjk + 8 * ldG) += *(Xik + 0 * ldX) * t8;
      *(Gik + 0 * ldG) += *(Xjk + 8 * ldX) * t8;
      t9 = *(temp + 19) * const_value;
      *(Gjk + 9 * ldG) += *(Xik + 0 * ldX) * t9;
      *(Gik + 0 * ldG) += *(Xjk + 9 * ldX) * t9;
      ...
      *(Gjk + 6 * ldG) += *(Xik + 1 * ldX) * t6;
      *(Gik + 1 * ldG) += *(Xjk + 6 * ldX) * t6;
      t7 = *(temp + 21) * const_value;
      *(Gjk + 7 * ldG) += *(Xik + 1 * ldX) * t7;
      *(Gik + 1 * ldG) += *(Xjk + 7 * ldX) * t7;
      t8 = *(temp + 22) * const_value;
      *(Gjk + 8 * ldG) += *(Xik + 1 * ldX) * t8;
      *(Gik + 1 * ldG) += *(Xjk + 8 * ldX) * t8;
      t9 = *(temp + 23) * const_value;
      *(Gjk + 9 * ldG) += *(Xik + 1 * ldX) * t9;
      *(Gik + 1 * ldG) += *(Xjk + 9 * ldX) * t9;
      ...
      *(Gjk + 6 * ldG) += *(Xik + 2 * ldX) * t6;
      *(Gik + 2 * ldG) += *(Xjk + 6 * ldX) * t6;
      t7 = *(temp + 22) * const_value;
      *(Gjk + 7 * ldG) += *(Xik + 2 * ldX) * t7;
      *(Gik + 2 * ldG) += *(Xjk + 7 * ldX) * t7;
      t8 = *(temp + 23) * const_value;
      *(Gjk + 8 * ldG) += *(Xik + 2 * ldX) * t8;
      *(Gik + 2 * ldG) += *(Xjk + 8 * ldX) * t8;
      t9 = *(temp + 24) * const_value;
      *(Gjk + 9 * ldG) += *(Xik + 2 * ldX) * t9;
      *(Gik + 2 * ldG) += *(Xjk + 9 * ldX) * t9;
