...
void integral_4_0(int npts,
   ...
   for(int point_idx = 0; point_idx < npts; ++point_idx) {
      ...
      *(Gjk + 10 * ldG) += *(Xik + 0 * ldX) * t10;
      *(Gik + 0 * ldG) += *(Xjk + 10 * ldX) * t10;
      t11 = *(temp + 11) * const_value;
      *(Gjk + 11 * ldG) += *(Xik + 0 * ldX) * t11;
      *(Gik + 0 * ldG) += *(Xjk + 11 * ldX) * t11;
      t12 = *(temp + 12) * const_value;
      *(Gjk + 12 * ldG) += *(Xik + 0 * ldX) * t12;
      *(Gik + 0 * ldG) += *(Xjk + 12 * ldX) * t12;
      t13 = *(temp + 13) * const_value;
      *(Gjk + 13 * ldG) += *(Xik + 0 * ldX) * t13;
      *(Gik + 0 * ldG) += *(Xjk + 13 * ldX) * t13;
      t14 = *(temp + 14) * const_value;
      *(Gjk + 14 * ldG) += *(Xik + 0 * ldX) * t14;
      *(Gik + 0 * ldG) += *(Xjk + 14 * ldX) * t14;
      ...
      *(Gjk + 10 * ldG) *= *(weights + point_idx);
      *(Gjk + 11 * ldG) *= *(weights + point_idx);
      *(Gjk + 12 * ldG) *= *(weights + point_idx);
      *(Gjk + 13 * ldG) *= *(weights + point_idx);
      *(Gjk + 14 * ldG) *= *(weights + point_idx);
