      ...
      for(int p_inner = 0; p_inner < NPTS_LOCAL; ++p_inner) {;
         ...
         for(int c0 = 0; c0 <= 4; ++c0) {
            for(int c1 = 0; c1 <= c0; ++c1) {
               ...
               mv = 4 + m; pv = 0 + p;
               *(Gik + 0 * ldG) += *(Xik + idxB * ldX) * (*(temp + (100 + (((8 - mv) * (8 - mv + 1)) >> 1) + pv) * NPTS_LOCAL + p_inner)) * (*(weights + (NPTS_LOCAL * p_outer + p_inner)));
               mv = 3 + m; pv = 0 + p;
               *(Gik + 1 * ldG) += *(Xik + idxB * ldX) * (*(temp + (100 + (((8 - mv) * (8 - mv + 1)) >> 1) + pv) * NPTS_LOCAL + p_inner)) * (*(weights + (NPTS_LOCAL * p_outer + p_inner)));
               mv = 3 + m; pv = 1 + p;
               *(Gik + 2 * ldG) += *(Xik + idxB * ldX) * (*(temp + (100 + (((8 - mv) * (8 - mv + 1)) >> 1) + pv) * NPTS_LOCAL + p_inner)) * (*(weights + (NPTS_LOCAL * p_outer + p_inner)));
               mv = 2 + m; pv = 0 + p;
               *(Gik + 3 * ldG) += *(Xik + idxB * ldX) * (*(temp + (100 + (((8 - mv) * (8 - mv + 1)) >> 1) + pv) * NPTS_LOCAL + p_inner)) * (*(weights + (NPTS_LOCAL * p_outer + p_inner)));
               mv = 2 + m; pv = 1 + p;
               *(Gik + 4 * ldG) += *(Xik + idxB * ldX) * (*(temp + (100 + (((8 - mv) * (8 - mv + 1)) >> 1) + pv) * NPTS_LOCAL + p_inner)) * (*(weights + (NPTS_LOCAL * p_outer + p_inner)));
               mv = 2 + m; pv = 2 + p;
               *(Gik + 5 * ldG) += *(Xik + idxB * ldX) * (*(temp + (100 + (((8 - mv) * (8 - mv + 1)) >> 1) + pv) * NPTS_LOCAL + p_inner)) * (*(weights + (NPTS_LOCAL * p_outer + p_inner)));
               mv = 1 + m; pv = 0 + p;
               *(Gik + 6 * ldG) += *(Xik + idxB * ldX) * (*(temp + (100 + (((8 - mv) * (8 - mv + 1)) >> 1) + pv) * NPTS_LOCAL + p_inner)) * (*(weights + (NPTS_LOCAL * p_outer + p_inner)));
               mv = 1 + m; pv = 1 + p;
               *(Gik + 7 * ldG) += *(Xik + idxB * ldX) * (*(temp + (100 + (((8 - mv) * (8 - mv + 1)) >> 1) + pv) * NPTS_LOCAL + p_inner)) * (*(weights + (NPTS_LOCAL * p_outer + p_inner)));
               mv = 1 + m; pv = 2 + p;
               *(Gik + 8 * ldG) += *(Xik + idxB * ldX) * (*(temp + (100 + (((8 - mv) * (8 - mv + 1)) >> 1) + pv) * NPTS_LOCAL + p_inner)) * (*(weights + (NPTS_LOCAL * p_outer + p_inner)));
               mv = 1 + m; pv = 3 + p;
               *(Gik + 9 * ldG) += *(Xik + idxB * ldX) * (*(temp + (100 + (((8 - mv) * (8 - mv + 1)) >> 1) + pv) * NPTS_LOCAL + p_inner)) * (*(weights + (NPTS_LOCAL * p_outer + p_inner)));
               mv = 0 + m; pv = 0 + p;
               *(Gik + 10 * ldG) += *(Xik + idxB * ldX) * (*(temp + (100 + (((8 - mv) * (8 - mv + 1)) >> 1) + pv) * NPTS_LOCAL + p_inner)) * (*(weights + (NPTS_LOCAL * p_outer + p_inner)));
               mv = 0 + m; pv = 1 + p;
               *(Gik + 11 * ldG) += *(Xik + idxB * ldX) * (*(temp + (100 + (((8 - mv) * (8 - mv + 1)) >> 1) + pv) * NPTS_LOCAL + p_inner)) * (*(weights + (NPTS_LOCAL * p_outer + p_inner)));
               mv = 0 + m; pv = 2 + p;
               *(Gik + 12 * ldG) += *(Xik + idxB * ldX) * (*(temp + (100 + (((8 - mv) * (8 - mv + 1)) >> 1) + pv) * NPTS_LOCAL + p_inner)) * (*(weights + (NPTS_LOCAL * p_outer + p_inner)));
               mv = 0 + m; pv = 3 + p;
               *(Gik + 13 * ldG) += *(Xik + idxB * ldX) * (*(temp + (100 + (((8 - mv) * (8 - mv + 1)) >> 1) + pv) * NPTS_LOCAL + p_inner)) * (*(weights + (NPTS_LOCAL * p_outer + p_inner)));
               mv = 0 + m; pv = 4 + p;
               *(Gik + 14 * ldG) += *(Xik + idxB * ldX) * (*(temp + (100 + (((8 - mv) * (8 - mv + 1)) >> 1) + pv) * NPTS_LOCAL + p_inner)) * (*(weights + (NPTS_LOCAL * p_outer + p_inner)));
            }
         }
      }
   }
