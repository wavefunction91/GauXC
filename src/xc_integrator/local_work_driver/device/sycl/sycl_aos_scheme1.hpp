...
#include "device/scheme1_onemkl_base.hpp"

namespace GauXC {

namespace alg_constants {

struct SyclAoSScheme1 {
  static constexpr uint32_t weight_unroll = 4;
  static constexpr uint32_t weight_thread_block = 512;
...
struct SyclAoSScheme1 : public Base {
...
extern template struct SyclAoSScheme1<AoSScheme1Base>;
extern template struct SyclAoSScheme1<AoSScheme1OneMKLBase>;

template <typename Base>
struct SyclAoSScheme1<Base>::Data : public Base::Data {
...
extern template struct SyclAoSScheme1<AoSScheme1Base>::Data;
extern template struct SyclAoSScheme1<AoSScheme1OneMKLBase>::Data;
