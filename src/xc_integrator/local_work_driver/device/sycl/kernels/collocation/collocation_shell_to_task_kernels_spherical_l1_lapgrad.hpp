...
static constexpr uint32_t collocation_device_shell_to_task_kernel_spherical_lapgrad_1_max_wg = 128;
static constexpr uint32_t collocation_device_shell_to_task_kernel_spherical_lapgrad_1_nwarp  = 4;


void collocation_device_shell_to_task_kernel_spherical_lapgrad_1(
  uint32_t                        nshell,
