...
static constexpr uint32_t collocation_device_shell_to_task_kernel_spherical_hessian_0_max_wg = 256;
static constexpr uint32_t collocation_device_shell_to_task_kernel_spherical_hessian_0_nwarp  = 8;


void collocation_device_shell_to_task_kernel_spherical_hessian_0(
  uint32_t                        nshell,
