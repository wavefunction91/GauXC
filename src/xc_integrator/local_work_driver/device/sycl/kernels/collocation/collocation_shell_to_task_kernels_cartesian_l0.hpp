...
static constexpr uint32_t collocation_device_shell_to_task_kernel_cartesian_0_max_wg = 512;
static constexpr uint32_t collocation_device_shell_to_task_kernel_cartesian_0_nwarp  = 16;


void collocation_device_shell_to_task_kernel_cartesian_0(
  uint32_t                        nshell,
