...
static constexpr uint32_t collocation_device_shell_to_task_kernel_spherical_2_max_wg = 512;
static constexpr uint32_t collocation_device_shell_to_task_kernel_spherical_2_nwarp  = 16;


void collocation_device_shell_to_task_kernel_spherical_2(
  uint32_t                        nshell,
