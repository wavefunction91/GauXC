...
static constexpr uint32_t collocation_device_shell_to_task_kernel_cartesian_gradient_1_max_wg = 256;
static constexpr uint32_t collocation_device_shell_to_task_kernel_cartesian_gradient_1_nwarp  = 8;


void collocation_device_shell_to_task_kernel_cartesian_gradient_1(
  uint32_t                        nshell,
