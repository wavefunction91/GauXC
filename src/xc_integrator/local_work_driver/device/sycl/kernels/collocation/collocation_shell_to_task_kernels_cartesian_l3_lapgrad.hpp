...
static constexpr uint32_t collocation_device_shell_to_task_kernel_cartesian_lapgrad_3_max_wg = 128;
static constexpr uint32_t collocation_device_shell_to_task_kernel_cartesian_lapgrad_3_nwarp  = 4;


void collocation_device_shell_to_task_kernel_cartesian_lapgrad_3(
  uint32_t                        nshell,
