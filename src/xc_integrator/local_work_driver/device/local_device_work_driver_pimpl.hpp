...
struct LocalDeviceWorkDriverPIMPL {
  ...
  virtual void eval_zmat_mgga_vxc_rks( XCDeviceData* ) = 0;
  virtual void eval_zmat_lda_vxc_uks( XCDeviceData* ) = 0;
  virtual void eval_zmat_gga_vxc_uks( XCDeviceData* ) = 0;
  virtual void eval_zmat_mgga_vxc_uks( XCDeviceData* ) = 0;
  virtual void eval_zmat_lda_vxc_gks( XCDeviceData* ) = 0;
  virtual void eval_zmat_gga_vxc_gks( XCDeviceData* ) = 0;
  virtual void eval_zmat_mgga_vxc_gks( XCDeviceData* ) = 0;
  virtual void eval_mmat_mgga_vxc_rks( XCDeviceData* ) = 0;
  virtual void eval_mmat_mgga_vxc_uks( XCDeviceData* ) = 0;
  virtual void eval_mmat_mgga_vxc_gks( XCDeviceData* ) = 0;
