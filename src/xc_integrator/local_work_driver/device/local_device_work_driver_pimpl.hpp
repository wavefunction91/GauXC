...
struct LocalDeviceWorkDriverPIMPL {
  ...
  virtual void eval_xmat( double fac, XCDeviceData*, bool do_grad ) = 0;
  ...
  virtual void eval_zmat_mgga_vxc_rks( XCDeviceData*, bool ) = 0;
  virtual void eval_zmat_lda_vxc_uks( XCDeviceData* ) = 0;
  virtual void eval_zmat_gga_vxc_uks( XCDeviceData* ) = 0;
  virtual void eval_zmat_mgga_vxc_uks( XCDeviceData*, bool ) = 0;
  virtual void eval_zmat_lda_vxc_gks( XCDeviceData* ) = 0;
  virtual void eval_zmat_gga_vxc_gks( XCDeviceData* ) = 0;
  virtual void eval_zmat_mgga_vxc_gks( XCDeviceData*, bool ) = 0;
  virtual void eval_mmat_mgga_vxc_rks( XCDeviceData*, bool ) = 0;
  virtual void eval_mmat_mgga_vxc_uks( XCDeviceData*, bool ) = 0;
  virtual void eval_mmat_mgga_vxc_gks( XCDeviceData*, bool ) = 0;
  virtual void inc_exc( XCDeviceData* ) = 0;
  virtual void inc_nel( XCDeviceData* ) = 0;
  virtual void inc_vxc( XCDeviceData*, bool ) = 0;
