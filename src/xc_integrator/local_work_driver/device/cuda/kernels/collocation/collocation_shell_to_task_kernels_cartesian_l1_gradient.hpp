...
__global__ __launch_bounds__(256,1) void collocation_device_shell_to_task_kernel_cartesian_gradient_1(
  int32_t                         nshell,
  ...
  for( int itask = global_warp_id; itask < ntasks; itask += nwarp_global ) {
    ...
    for( int ipt = warp_rank /*+ (blockIdx.y*cuda::warp_size)*/; ipt < npts; ipt += (/*gridDim.y * */cuda::warp_size) ) {
      ...
      dang_eval_x_0 = radial_eval + radial_eval_x*x;
      dang_eval_y_0 = radial_eval_y*x;
      dang_eval_z_0 = radial_eval_z*x;
      dang_eval_x_1 = radial_eval_x*y;
      dang_eval_y_1 = radial_eval + radial_eval_y*y;
      dang_eval_z_1 = radial_eval_z*y;
      dang_eval_x_2 = radial_eval_x*z;
      dang_eval_y_2 = radial_eval_y*z;
      dang_eval_z_2 = radial_eval + radial_eval_z*z;
