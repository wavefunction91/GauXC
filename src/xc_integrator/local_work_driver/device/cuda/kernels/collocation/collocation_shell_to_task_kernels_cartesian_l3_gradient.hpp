...
__global__ __launch_bounds__(1024,1) void collocation_device_shell_to_task_kernel_cartesian_gradient_3(
  size_t                            ntasks,
  ...
  for( int itask = global_warp_id; itask < ntasks; itask += nwarp_global ) {
    ...
    for( int ipt = warp_rank; ipt < npts; ipt += cuda::warp_size ) {
      ...
      dang_eval_x = x*x*(3*radial_eval + radial_eval_x*x);
      dang_eval_y = radial_eval_y*x*x*x;
      dang_eval_z = radial_eval_z*x*x*x;
      ...
      dang_eval_x = x*y*(2*radial_eval + radial_eval_x*x);
      dang_eval_y = x*x*(radial_eval + radial_eval_y*y);
      dang_eval_z = radial_eval_z*x*x*y;
      ...
      dang_eval_x = x*z*(2*radial_eval + radial_eval_x*x);
      dang_eval_y = radial_eval_y*x*x*z;
      dang_eval_z = x*x*(radial_eval + radial_eval_z*z);
      ...
      dang_eval_x = y*y*(radial_eval + radial_eval_x*x);
      dang_eval_y = x*y*(2*radial_eval + radial_eval_y*y);
      dang_eval_z = radial_eval_z*x*y*y;
      ...
      dang_eval_x = y*z*(radial_eval + radial_eval_x*x);
      dang_eval_y = x*z*(radial_eval + radial_eval_y*y);
      dang_eval_z = x*y*(radial_eval + radial_eval_z*z);
      ...
      dang_eval_x = z*z*(radial_eval + radial_eval_x*x);
      dang_eval_y = radial_eval_y*x*z*z;
      dang_eval_z = x*z*(2*radial_eval + radial_eval_z*z);
      ...
      dang_eval_x = radial_eval_x*y*y*y;
      dang_eval_y = y*y*(3*radial_eval + radial_eval_y*y);
      dang_eval_z = radial_eval_z*y*y*y;
      ...
      dang_eval_x = radial_eval_x*y*y*z;
      dang_eval_y = y*z*(2*radial_eval + radial_eval_y*y);
      dang_eval_z = y*y*(radial_eval + radial_eval_z*z);

      basis_eval  [ipt + 7*npts] = ang_eval;
      basis_x_eval[ipt + 7*npts] = dang_eval_x;
      basis_y_eval[ipt + 7*npts] = dang_eval_y;
      basis_z_eval[ipt + 7*npts] = dang_eval_z;


      ang_eval = radial_eval*y*z*z;
      dang_eval_x = radial_eval_x*y*z*z;
      dang_eval_y = z*z*(radial_eval + radial_eval_y*y);
      dang_eval_z = y*z*(2*radial_eval + radial_eval_z*z);

      basis_eval  [ipt + 8*npts] = ang_eval;
      basis_x_eval[ipt + 8*npts] = dang_eval_x;
      basis_y_eval[ipt + 8*npts] = dang_eval_y;
      basis_z_eval[ipt + 8*npts] = dang_eval_z;


      ang_eval = radial_eval*z*z*z;
      dang_eval_x = radial_eval_x*z*z*z;
      dang_eval_y = radial_eval_y*z*z*z;
      dang_eval_z = z*z*(3*radial_eval + radial_eval_z*z);

      basis_eval  [ipt + 9*npts] = ang_eval;
      basis_x_eval[ipt + 9*npts] = dang_eval_x;
      basis_y_eval[ipt + 9*npts] = dang_eval_y;
      basis_z_eval[ipt + 9*npts] = dang_eval_z;
