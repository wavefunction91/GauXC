...
def generate_shell_to_task_lines( ang, deriv_order = 0 ):
  ...
  if deriv_order == 0:   return bf_eval_strs
    ...
    return [bf_xx_eval_strs, bf_xy_eval_strs, bf_xz_eval_strs, bf_yy_eval_strs, bf_yz_eval_strs, bf_zz_eval_strs]
...
for L in range( L_max + 1 ):
  ...
  [bfxx,bfxy,bfxz,bfyy,bfyz,bfzz] = generate_shell_to_task_lines(cart_ang,2)
  ...
  [bfxx,bfxy,bfxz,bfyy,bfyz,bfzz] = generate_shell_to_task_lines(sph_ang,2)
...
def generate_code_hessian( eval_lines, eval_lines_dx, eval_lines_dy, eval_lines_dz, eval_lines_dxx, eval_lines_dxy, eval_lines_dxz, eval_lines_dyy, eval_lines_dyz, eval_lines_dzz, L, eval_type, template_fname, output_fname ):
  old_sysout = sys.stdout
  var_dict = { 'eval_lines' : eval_lines,
               'eval_lines_dx' : eval_lines_dx, 
               'eval_lines_dy' : eval_lines_dy, 
...
for L in range( L_max + 1 ):
  ...
  generate_code_hessian( cart_bf_lines[L], cart_bfx_lines[L], cart_bfy_lines[L], cart_bfz_lines[L],
    ...
    cart_bfzz_lines[L], L, 'cartesian_hessian', template_fname, cart_header_fname )
  generate_code_hessian( sph_bf_lines[L], sph_bfx_lines[L], sph_bfy_lines[L], sph_bfz_lines[L],
    ...
    sph_bfzz_lines[L], L, 'spherical_hessian', template_fname, sph_header_fname )
