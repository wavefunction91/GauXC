...
GPGAUEVAL_INLINE __device__ void gaueval_$(name)_angular_$(L)_deriv1(
  const double bf,
  const double bf_x,
  const double bf_y,
  const double bf_z,
...
GPGAUEVAL_INLINE __device__ void gaueval_$(name)_angular(
  const int64_t l,
  const double  bf,
  const double  x,
  const double  y,
...
GPGAUEVAL_INLINE __device__ void gaueval_$(name)_angular_deriv1(
  const int64_t l,
  const double  bf,
  const double  bf_x,
  const double  bf_y,
