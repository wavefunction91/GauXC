...
GPGAUEVAL_INLINE __device__ void collocation_cartesian_angular(
  ...
  T*  eval
      ...
      if( l == 0 ) {
        ...
        collocation_cartesian_angular<T,0>( bf, x, y, z, eval );

      } else if( l == 1 ) {
  
        collocation_cartesian_angular<T,1>( bf, x, y, z, eval );

      } else if( l == 2 ) {
  
        collocation_cartesian_angular<T,2>( bf, x, y, z, eval );

      } else if( l == 3 ) {
  
        collocation_cartesian_angular<T,3>( bf, x, y, z, eval );
...
GPGAUEVAL_INLINE __device__ void collocation_cartesian_angular_deriv1(
  ...
  T*  eval_z
      ...
      if( l == 0 ) {
        ...
        collocation_cartesian_angular_deriv1<T,0>( bf, bf_x, bf_y, bf_z, x, y, z, eval, eval_x, eval_y, eval_z );

      } else if( l == 1 ) {
  

        collocation_cartesian_angular_deriv1<T,1>( bf, bf_x, bf_y, bf_z, x, y, z, eval, eval_x, eval_y, eval_z );

      } else if( l == 2 ) {
  

        collocation_cartesian_angular_deriv1<T,2>( bf, bf_x, bf_y, bf_z, x, y, z, eval, eval_x, eval_y, eval_z );

      } else if( l == 3 ) {
  

        collocation_cartesian_angular_deriv1<T,3>( bf, bf_x, bf_y, bf_z, x, y, z, eval, eval_x, eval_y, eval_z );
