...
struct SYCLBackend : public DeviceBackend {
  ...
  std::vector<std::shared_ptr<util::sycl_queue>>    blas_streams;
  std::vector<std::shared_ptr<util::onemkl_handle>> blas_handles;
};
