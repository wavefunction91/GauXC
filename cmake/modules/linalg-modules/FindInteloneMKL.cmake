...
#      intelonemkl_PREFERED_THREAD_LEVEL   - ( sequential, tbb ) default: sequential 
...
if( NOT intelonemkl_PREFERED_THREAD_LEVEL )
  set( intelonemkl_PREFERED_THREAD_LEVEL "sequential" )
endif()
...
elseif( intelonemkl_PREFERED_THREAD_LEVEL MATCHES "tbb" )
  ...
  message( FATAL_ERROR "OneMKL Only accepts sequential / TBB" )
...
# SYCL
find_library( intelonemkl_SYCL_LIBRARY
  NAMES ${intelonemkl_SYCL_LIBRARY_NAME}
  HINTS ${intelonemkl_PREFIX}
  PATHS ${intelonemkl_LIBRARY_DIR} ${CMAKE_C_IMPLICIT_LINK_DIRECTORIES}
  PATH_SUFFIXES lib/intel64 lib/ia32
  DOC "Intel(R) SYCL MKL Library"
)
...
message( STATUS ${intelonemkl_LIBRARY} )
message( STATUS ${intelonemkl_THREAD_LIBRARY} )
message( STATUS ${intelonemkl_CORE_LIBRARY} )

if( intelonemkl_LIBRARY AND intelonemkl_CORE_LIBRARY AND intelonemkl_SYCL_LIBRARY AND intelonemkl_THREAD_LIBRARY )

  if( intelonemkl_PREFERS_STATIC )
    message( FATAL_ERROR "STATIC OneMKL NOT YET SETUP" )
    ...
    set( InteloneMKL_LIBRARIES  ${intelonemkl_SYCL_LIBRARY} ${intelonemkl_LIBRARY} ${intelonemkl_THREAD_LIBRARY} ${intelonemkl_CORE_LIBRARY} )
  ...
  if( intelonemkl_PREFERED_THREAD_LEVEL MATCHES "tbb" )
