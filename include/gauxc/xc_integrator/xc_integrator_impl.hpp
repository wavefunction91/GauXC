...
protected:
  ...
  virtual exc_vxc_type_gks  eval_exc_vxc_ ( const MatrixType& Ps, const MatrixType& Pz, const MatrixType& Px, const MatrixType& Py, 
...
public:
 ...
 value_type integrate_den( const MatrixType& P ) {
  ...
  exc_vxc_type_gks eval_exc_vxc( const MatrixType& Ps, const MatrixType& Pz, const MatrixType& Px, const MatrixType& Py, const IntegratorSettingsXC& ks_settings ) {
    return eval_exc_vxc_(Ps, Pz, Px, Py, ks_settings);
  }
